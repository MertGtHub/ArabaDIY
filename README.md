<div align="right">
  <span id="language-buttons" style="display: inline-block; margin-bottom: 20px;">
    <button id="tr-button" onclick="changeLanguage('tr')" style="background-color: #4CAF50; color: white; border: none; padding: 8px 16px; text-align: center; text-decoration: none; display: inline-block; font-size: 14px; margin: 4px 2px; cursor: pointer; border-radius: 4px; font-weight: bold;">🇹🇷 Türkçe</button>
    <button id="en-button" onclick="changeLanguage('en')" style="background-color: #008CBA; color: white; border: none; padding: 8px 16px; text-align: center; text-decoration: none; display: inline-block; font-size: 14px; margin: 4px 2px; cursor: pointer; border-radius: 4px;">🇬🇧 English</button>
  </span>
</div>
